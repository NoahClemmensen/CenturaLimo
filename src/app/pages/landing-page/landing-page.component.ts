...
export class LandingPageComponent {
  ...
  protected images: { path: string, text?: string }[] = [
    { path: 'public/images/wheel.jpg', text: 'The centura is equipped with 3-piece wheels with gold bolts and a spinner badge.' },
    { path: 'public/images/cloth.jpg', text: 'The comfortable cloth inside, on the seats, to keep you warm and the wool seats clean' },
    { path: 'public/images/inside.jpg', text: 'The inside of the centura, with a center console and wool upholstery' },
    { path: 'public/images/gangsta.jpg', text: 'A customers experience with our services' },
    { path: 'public/images/gangstainside.jpg' },
    { path: 'public/images/gangstasmoke.jpg' },
    { path: 'public/images/opendoor.jpg' },
    { path: 'public/images/downlow.jpg', text: 'The centura from a low angle, showing the wheels and the side of the car' },
    { path: 'public/images/sideview.jpg' },
    { path: 'public/images/lowbehind.jpg' },
  ];
